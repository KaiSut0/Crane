...
namespace Crane.Components.Patterns
{
    public class HuffmanExtrudedBoxesOnDoubleSurfaceComponent : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("SlideParam1", "SlideParam1", "First slide parameter for Huffman Extruded Boxes",
                GH_ParamAccess.item, 0.25);
            pManager.AddNumberParameter("SlideParam2", "SlideParam2", "Second slide parameter for Huffman Extruded Boxes",
