...
{
    public class MiuraFoldingComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MiuraFoldingComponent class.
        /// </summary>
        public MiuraFoldingComponent()
          : base("Miura Foldingt", "Miura Folding",
              "Create Miura folding crease pattern.",
              "Crane", "Pattern")
        {
        }
        ...
        {
            get { return new Guid("2C983188-8BFA-43BB-9284-40B2D39E209F"); }
        }
    }
}